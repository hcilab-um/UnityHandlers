...
function Update () {
	if (gyroBool) {
		#if UNITY_IPHONE || (UNITY_ANDROID && (UNITY_4_0 || UNITY_4_1 || UNITY_4_3))
...
function fixScreenOrientation() {	
	#if UNITY_IPHONE && (UNITY_4_0 || UNITY_4_1)
		...
		if (Screen.orientation == ScreenOrientation.LandscapeLeft) {
			quatMult = Quaternion(0,0,0.7071,0.7071); // seems to have changed as of Unity 4.0
	...
	#endif
	#if UNITY_ANDROID && (UNITY_4_0 || UNITY_4_1 || UNITY_4_3)
